...
class DataFrameFormatterSuricata():
    ...
    def format_suricata_df(self):
        ...
        # Now rename columns
        suricata_df_renamed = suricata_df_renamed.rename(columns={
        ...
        suricata_df_renamed[self.list_of_features_to_rename[7]] = suricata_df_renamed[self.list_of_features_to_rename[7]].astype(float)
