...
class DataFrameFormatterNormalTraffic():
    ...
    def format_normal_traffic_df(self):
        ...
        normal_df_renamed = normal_df_renamed.rename(columns={
            ...
            'destinationPort': self.list_of_features_to_rename[3],          # destination_port
            'startDateTime': self.list_of_features_to_rename[4],            # timestamp_start
            'protocolName': self.list_of_features_to_rename[5],             # transport_protocol
            ...
            'totalDestinationBytes': self.list_of_features_to_rename[9],    # bytes_received
            'totalSourcePackets': self.list_of_features_to_rename[10],      # pkts_sent
            'totalDestinationPackets': self.list_of_features_to_rename[11], # pkts_received
        ...
        normal_df_renamed[self.list_of_features_to_rename[5]] = normal_df_renamed[self.list_of_features_to_rename[5]].str.replace('_ip', '', regex=False)
        
        # Convert application_protocol to lowercase
        normal_df_renamed[self.list_of_features_to_rename[6]] = normal_df_renamed[self.list_of_features_to_rename[6]].str.lower()
    ...
    def _clean_data(self, df):
        ...
        df[self.list_of_features_to_rename[2]] = df[self.list_of_features_to_rename[2]].astype(int)   # source_port
        df[self.list_of_features_to_rename[3]] = df[self.list_of_features_to_rename[3]].astype(int)   # destination_port
        df[self.list_of_features_to_rename[8]] = df[self.list_of_features_to_rename[8]].astype(int)   # bytes_sent
        df[self.list_of_features_to_rename[9]] = df[self.list_of_features_to_rename[9]].astype(int)   # bytes_received
        df[self.list_of_features_to_rename[10]] = df[self.list_of_features_to_rename[10]].astype(int) # pkts_sent
        df[self.list_of_features_to_rename[11]] = df[self.list_of_features_to_rename[11]].astype(int) # pkts_received
