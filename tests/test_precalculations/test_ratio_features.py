...
class TestCalculateRatioFeatures:
    ...
    def test_calculate_ratio_features_basic(self):
        ...
        # Check calculations
        assert result['bytes_sent_ratio'].iloc[0] == pytest.approx(0.667, rel=0.01)  # 1000/1500
        assert result['packets_sent_ratio'].iloc[0] == pytest.approx(0.667, rel=0.01)  # 10/15
