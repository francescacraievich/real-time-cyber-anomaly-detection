...
class GridSearchOptimizer:
    ...
    def grid_search_hyperparameters(
        self, df_benign, df_test=None, max_train_samples=5000
    ):
        ...
        if len(X_benign) > max_train_samples:
            X_benign = X_benign.sample(
                n=max_train_samples, random_state=self.model.random_state
            )
        ...
        print(
            f"[GridSearch] Testing {len(param_combinations)} parameter combinations..."
        )
    ...
    def fit_with_grid_search(
        self, df_benign, df_test=None, max_train_samples=10000, contamination=0.1
    ):
    ...
    def fit_or_load_with_grid_search(
        self,
        df_benign,
        df_test=None,
